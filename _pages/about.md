...
I’m Mohammed Omer, a mechanical engineer and doctoral researcher at the Helmut Schmidt University in Hamburg. My work focuses on designing frugal, open-source machine tools for microenterprises in resource-constrained settings. I combine hands-on prototyping with field research to understand how accessible manufacturing technologies can expand opportunities for small workshops and migrant-led enterprises.

My path into engineering began with an apprenticeship in a steel fabrication shop, and since then I’ve worked across the construction, automotive, and aerospace sectors, including roles in manufacturing R&D and technical documentation for Airbus. These experiences, together with my upbringing in Oman and Bangladesh, shaped my interest in using engineering to address real social and economic constraints.

Beyond research, I enjoy building hobby projects, fixing things, and collecting useful parts from old machines. I also unwind with anime and a good book—biography or fiction alike.
